...
func main() {
	...
	reviewReportsCli := cli.NewReviewReportCli(router, reader, handlers.NewReviewHandler(repos.NewReviewsRepo(db)))
	// assign routes
	...
	router.AddRouteCli(routes.REVIEWS_REPORT_ROUTE, reviewReportsCli)
